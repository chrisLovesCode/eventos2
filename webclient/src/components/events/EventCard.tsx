...
export function EventCard({ event }: EventCardProps) {
  // Datum formatieren für die Datum-Box mit expliziter Zeitzone
  ...
  // Zeit formatieren mit expliziter Zeitzone
  ...
  // Datum formatieren mit expliziter Zeitzone
  ...
  return (
    <div className="card-hover group flex flex-col overflow-hidden glass-card bg-card">
      {/* Bild-Header mit Datum-Box und Titel */}
      <Link
